...
export default tool({
  ...
  args: {
    ...
    actor: tool.schema.string().optional().describe("操作者标识（旧字段，优先用 caller）"),
    caller: tool.schema.string().optional().describe("调用者标识 (orchestrator/crafter/ideation/search-analysis)"),
