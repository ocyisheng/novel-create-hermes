...
description: "V2 规划子技能：为 novel-planner 提供结构化规划能力，包括焦点选择、约束库查询、方案生成、单元创建等"
license: "MIT"
version: "2.0.0"
compatibility: "OpenCode"
tags: ["novel", "v2", "planning", "novel-planner", "graph", "structure"]
---
...
本技能为 **novel-planner** 主 agent 提供结构化规划能力，负责：
- 焦点选择与上下文预热
- 约束库查询与方案生成
- 叙事单元创建与关系构建
- 质量检查与偏差管理
...
| **提示词层** | 业务逻辑、领域知识、创作指导 | `novel-planner` → `novel-v2-planning` → `novel-v2-writing` |
