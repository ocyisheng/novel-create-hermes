---
name: "novel-writer-develop"
description: "V2 小说创作全流程调度中心（开发者版）。含遥测、分析、会话总结等开发者工具。触发词：写小说、章节、角色、世界观、情节、总纲、大纲、导出、可视化、关系图、时间线、项目管理、环境、知识库、搜索、收集使用数据、分析遥测数据、记录会话总结"
---
