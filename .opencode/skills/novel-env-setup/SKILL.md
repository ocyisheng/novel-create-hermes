...
```bash
# Windows
.opencode/skills/novel-env-setup/setup_env.bat

# macOS/Linux
chmod +x .opencode/skills/novel-env-setup/setup_env.sh && ./.opencode/skills/novel-env-setup/setup_env.sh
```

脚本自动检测 Python 来源（系统 Python → conda），创建 `.venv` + `pip install`。
