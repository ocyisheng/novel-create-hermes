...
description: "V2 分析子技能：为 novel-v2-analyzer 提供偏差检测、质量检查、优化建议等分析能力"
license: "MIT"
version: "2.0.0"
compatibility: "OpenCode"
tags: ["novel", "v2", "analysis", "novel-v2-analyzer", "graph", "quality"]
---
...
本技能为 **novel-v2-analyzer** 主 agent 提供分析能力，负责：
- 偏差检测与分类
- 质量检查与验证
- 优化建议与修复
- 会话分析与统计
...
| **提示词层** | 业务逻辑、领域知识、创作指导 | `novel-v2-analyzer` → `novel-v2-analysis` → `novel-v2-writing` |
